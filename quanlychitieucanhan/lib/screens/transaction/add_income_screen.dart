...
class _AddIncomeScreenState extends State<AddIncomeScreen> {
  ...
  final _categories = const ['Lương', 'Thưởng', 'Trợ cấp', 'Đầu tư', 'Khác'];
  ...
  void _submit() {
    ...
    context.read<ExpenseModel>().addIncome(amount, note, _selectedCategory);

    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Đã lưu khoản thu ${_vnd.format(amount)}')),
    );
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Lưu khoản thu'),
